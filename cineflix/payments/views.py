...
from subscriptions.models import SubscriptionPlans,UserSubcriptions
...
class RazorPayView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        with transaction.atomic():
            ...
            user_subscription =UserSubcriptions.objects.create(profile=user,plan=plan)
...
class PaymentVerifyView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if paid : 
            ...
            user_subcription = transaction_obj.user_subscription
            ...
            user_subcription.start_date = start_date

            user_subcription.end_date = end_date

            user_subcription.active = True
        ...
        return redirect('razorpay',uuid=user_subcription.plan.uuid)
