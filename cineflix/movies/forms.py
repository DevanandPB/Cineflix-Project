...
# runtime = forms.TimeField(input_formats=['%H:%M'],widget=forms.TimeInput(attrs={'class':'form-control','type':'time'},format='%H:%M'))
    ...
    def clean(self):
        ...
        if photo and photo.size > 3*1024*1024 :
            ...
            self.add_error('photo','Maximum file is upto 3 MB')
